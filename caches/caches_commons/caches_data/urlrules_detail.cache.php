...
return array (
  ...
  array (
    ...
    'file' => 'show',
    'ishtml' => '1',
    'urlrule' => '{$categorydir}{$catdir}/show_{$id}_{$page}.html|{$categorydir}{$catdir}/index.html',
    'example' => '{$categorydir}{$catdir}/show_{$id}_{$page}.html',
  ),
  16 => 
  array (
    'urlruleid' => '16',
