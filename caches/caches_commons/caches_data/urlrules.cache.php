...
return array (
  ...
  12 => '{$categorydir}{$catdir}/{$id}.html|{$categorydir}{$catdir}/{$id}_{$page}.html',
  31 => '{$categorydir}{$catdir}/show_{$id}_{$page}.html|{$categorydir}{$catdir}/index.html',
