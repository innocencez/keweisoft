...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo CSS_PATH;?>official/abbrief.css" />
		...
		<div class="content">
			...
			<div class="m-content ab-brief">
				...
				<p class="ab-brief-con">
					       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;北京可为时代科技有限公司成立于1993年，是国内领先的提供整体解决方案的企业管理咨询公司。公司拥有近200人的专业咨询和专家团队，专注于为企业提供系统的企业管理咨询与业务解决方案。我们和客户一起，通过对企业管理过程中所遇问题的不断改进，帮助客户实现持续、稳定、健康的发展，达成战略目标。<br/>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目前可为公司已经迎来了它的第21个年头，在为客户度身订制的企业管理咨询解决方案中，可为软件已经为几十个行业上万家客户提供了高质量的管理软件产品和解决方案，获得了客户的一致好评，并与公司建立起了长期合作关系。<br />
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;未来，可为软件将继续运用营销管理的最新理论，结合软件技术的深厚积淀，提供满足客户需求的信息化解决方案和服务目标，公司也将继续秉承“服务创造价值、服务创造未来”的经营理念，以专业的视角为客户提供优质服务，通过传递管理知识，推进信息化，助力企业大有可为，让每一家企业信息化管理更轻松！打造中国企业管理软件第一品牌！成就中国最具规模的综合型管理咨询服务机构！
				...
				<div class="ab-con-mission">
					<img src="<?php echo IMG_PATH;?>keweisoft/ab-con-vis.png" alt="" title="" />
			...
			<div class="ab-vision">
					...
					<div class="vision3">
						<div class="vision-motto">可为公司的员工信条</div>
						<div class="vision-line"></div>
						<div class="vision1-con">有理想、有道德、有文化、有纪律</div>
					</div>
					<div class="vision4">
...
赖，做一个让最终企业用户满意的软件服务公司！</div>
			...
			<a href=""><div class="ab-ads"></div></a>
			<div class="m-content">
				<div class="ab-sub">
					<img src="<?php echo IMG_PATH;?>keweisoft/ab-pic1.jpg" alt="" title="" style="float:left;" />
				...
				<div class="ab-sub1">
					<div class="ab-sub-con1">
						<p style="font-size:14px;margin-top:20px;line-height:25px;text-indent:28px;">可为时代自主研发的edus教务系统，目前已成功应用于教育培训行业，致力于教育培训机构/学校的校区、学员、教师、排课、考勤、成绩、财务管理等，帮助企业解决管理难、管理分散的问题。目前已成为教育培训行业内的领先品牌。</p>
					</div>
					<img src="<?php echo IMG_PATH;?>keweisoft/ab-pic2.jpg" alt="" title="" style="float:left; margin-left:150px;" />
				</div>
				...
				<div class="ab-sub1-case-item1">
					<div class="ab-sub1-case-item1-items"><a href=""><img src="<?php echo IMG_PATH;?>keweisoft/ab-case1.jpg" alt="" title="" /></a></div>
					<div class="ab-sub1-case-item1-items" style="margin-left:25px;"><a href=""><img src="<?php echo IMG_PATH;?>keweisoft/ab-case2.jpg" alt="" title="" /></a></div>
					<div class="ab-sub1-case-item1-items" style="margin-left:83px;"><a href=""><img src="<?php echo IMG_PATH;?>keweisoft/ab-case3.jpg" alt="" title="" /></a></div>
				</div>
				<div class="ab-sub1-case-item2">
					<div class="ab-sub1-case-item2-items"><a href=""><img src="<?php echo IMG_PATH;?>keweisoft/ab-case4.jpg" alt="" title="" /></a></div>
					<div class="ab-sub1-case-item2-items" style="margin-left:25px;"><a href=""><img src="<?php echo IMG_PATH;?>keweisoft/ab-case5.jpg" alt="" title="" /></a></div>
					<div class="ab-sub1-case-item2-items" style="margin-left:83px;"><a href=""><img src="<?php echo IMG_PATH;?>keweisoft/ab-case6.jpg" alt="" title="" /></a></div>
				</div>
				<div class="ab-case-line"></div>
			</div>
			<a href=""><div class="ab-ads2"></div></a>

			<div class="m-content">
				<div class="ab-sub">
					<div class="ab-sub-con" style="margin-left:0px;">
						<h1>可为—为您私人定制的管理系统</h1>
					...
					<img src="<?php echo IMG_PATH;?>keweisoft/ab-pic3.jpg" alt="" title="" style="float:left;margin-left:152px;" />
				</div>
				<div class="sub-con-line"></div>
				<div class="ab-sub1" style="margin-top:35px;">
					<img src="<?php echo IMG_PATH;?>keweisoft/ab-pic4.jpg" alt="" title="" style="float:left;" />
		...
		<a href=""><div class="ab-ads3"></div></a>
	<div class="m-content">
		<div class="ab-sub">
					<div class="ab-sub-con" style="margin-left:0px;">
					...
					<img src="<?php echo IMG_PATH;?>keweisoft/ab-pic5.jpg" alt="" title="" style="float:left;margin-left:152px;" />
		</div>
		<div class="ab-ads1">
			<span>咨询服务</span>
			<a href="">点击了解详情</a>
		...
		<div class="ab-consult">
			<img src="<?php echo IMG_PATH;?>keweisoft/ab-con-tel.jpg" alt="" title="" style="margin-left:29px;float:left;" />
			<div class="ab-consult-con">可为拥有最优质的咨询顾问服务团队，他们拥有多年的行业纵深经验，对企业的业务流程和盈利模式都有较深的了解，通过可为专业的咨询顾问，我们协助企业找到管理现状中存在的问题、优化企业现有流程中的各个环节、针对企业当前的管理问题给出全方面的解决方案，包括行业现状的分析、企业流程的优化、管理思想的应用以及最终的软件落地执行。</div>
		</div>
		<div class="ab-consult-process">
			咨询服务流程：
			<div class="ab-consult-process-con">
				<div class="ab-process-con1" onmouseover="this.style.backgroundImage='url(<?php echo IMG_PATH;?>keweisoft/ab-consult-hover1.jpg)';document.getElementById('at1').style.display='none'" onmouseout="this.style.backgroundImage='url(<?php echo IMG_PATH;?>keweisoft/ab-consult1.jpg)';document.getElementById('at1').style.display='block'"><div style="margin-top:125px;" id="at1">需求调研</div></div>
				<div id="ah1"></div>
				<div class="ab-process-arrow"></div>
				<div class="ab-process-con2" onmouseover="this.style.backgroundImage='url(<?php echo IMG_PATH;?>keweisoft/ab-consult-hover2.jpg)';document.getElementById('at2').style.display='none'" onmouseout="this.style.backgroundImage='url(<?php echo IMG_PATH;?>keweisoft/ab-consult2.jpg)';document.getElementById('at2').style.display='block'"><div style="margin-top:125px;" id="at2">需求分析</div></div>
				<div class="ab-process-arrow"></div>
				<div class="ab-process-con3" onmouseover="this.style.backgroundImage='url(<?php echo IMG_PATH;?>keweisoft/ab-consult-hover3.jpg)';document.getElementById('at3').style.display='none'" onmouseout="this.style.backgroundImage='url(<?php echo IMG_PATH;?>keweisoft/ab-consult3.jpg)';document.getElementById('at3').style.display='block'"><div style="margin-top:125px;" id="at3">需求确认</div></div>
				<div class="ab-process-arrow"></div>
				<div class="ab-process-con4" onmouseover="this.style.backgroundImage='url(<?php echo IMG_PATH;?>keweisoft/ab-consult-hover4.jpg)';document.getElementById('at4').style.display='none'" onmouseout="this.style.backgroundImage='url(<?php echo IMG_PATH;?>keweisoft/ab-consult4.jpg)';document.getElementById('at4').style.display='block'"><div style="margin-top:125px;" id="at4">价值确认</div></div>
			</div>
		</div>
		<div class="ab-ads1">
			<span>实施服务</span>
		...
		<div class="ab-consult">	
			...
			<img src="<?php echo IMG_PATH;?>keweisoft/ab-con-ico.jpg" alt="" title="" style="margin-left:35px;float:left;" />
		</div>
		<div class="ab-consult-process">
			实施服务流程：
		...
		<div class="ab-consult">
			<img src="<?php echo IMG_PATH;?>keweisoft/ab-con-ico9.jpg" alt="" title="" style="margin-left:20px;float:left;" />
		...
		<div class="ab-consult">	
			<div class="ab-consult-con" style="margin-left:0px">可为拥有最优质的咨询顾问服务团队，他们拥有多年的行业纵深经验，对企业的业务流程和盈利模式都有较深的了解，通过可为专业的咨询顾问，我们协助企业找到管理现状中存在的问题、优化企业现有流程中的各个环节、针对企业当前的管理问题给出全方面的解决方案，包括行业现状的分析、企业流程的优化、管理思想的应用以及最终的软件落地执行。</div>
			<img src="<?php echo IMG_PATH;?>keweisoft/ab-con-ico10.jpg" alt="" title="" style="margin-left:35px;float:left;" />
		</div>
	</div>
		</div>
	</div>
