...
function changeFocus(dir) {
	...
	if(dir) {
		...
		$("#focusIndex"+currentFocusI+" .focusR").animate({left: -($(window).width()/2+1000)},500,'easeInExpo',function(){
				$("#focusIndex"+nextI+" .focusL").animate({left: -520},1000,'easeInOutCirc');
				$("#focusIndex"+nextI+" .focusR").animate({left: -520},1200,'easeInOutCirc');
		...
		$("#focusIndex"+currentFocusI+" .focusL").animate({left: $(window).width()/2},500,'easeInExpo',function(){
				$("#focusIndex"+nextI+" .focusL").animate({left: -520},1200,'easeInOutCirc');
				$("#focusIndex"+nextI+" .focusR").animate({left: -520},1000,'easeInOutCirc');
