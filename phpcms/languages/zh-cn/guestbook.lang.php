...
$LANG['introduce_noempty']				=	'留言内容不能为空';
$LANG['add_success']					=	'您的留言提交成功,正在返回!';
$LANG['suspend_application']			=	'系统暂停留言,请联系在线客服!';

$LANG['guestbook_exit']					=	'留言不存在';
$LANG['guesttype_exit']					=	'留言分类不存在';
...
$LANG['application_or_not']				=	'是否允许留言';
