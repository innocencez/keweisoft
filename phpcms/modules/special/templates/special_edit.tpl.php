...
<div id="div_setting_1" class="contentList pad-10">
	<table class="table_form" width="100%" cellspacing="0">
		<tbody>
			...
			<tr>
				<th><?php echo L('special_thumb')?>：</th>
				<td><?php echo form::images('special[thumb]', 'thumb', $info['thumb'], 'special', '', 40, '', '', '', array(350, 350))?></td>
			</tr>
			<tr>
				<th><?php echo L('special_types')?>：</th>
				<td><?php echo form::select_linkage(3386,0,'special[typeid]','','',$info['typeid'])?></td>
			</tr>	
			<tr>
				<th width="200"><?php echo '所属行业'?>：</th>
				<td><input name="special[indus]" id="indus" class="input-text" value="<?php echo new_html_special_chars($info['indus']);?>" type="text" size="40"></td>
			</tr>	
			<tr>
				<th><?php echo '机构规模'?>：</th>
				<td><?php echo form::select_linkage(3370,0,'special[scale]','','',$info['scale'])?></td>
			</tr>
			<tr>
				<th width="200"><?php echo '应用模块'?>：</th>
				<td><input name="special[func_tags]" id="func_tags" class="input-text" value="<?php echo new_html_special_chars($info['func_tags']);?>" type="text" size="40"></td>
			</tr>
			<tr>
				<th width="200"><?php echo '系统价值'?>：</th>
				<td><input name="special[values]" id="values" class="input-text" value="<?php echo new_html_special_chars($info['values']);?>" type="text" size="40"></td>
			</tr>	
			<tr>
