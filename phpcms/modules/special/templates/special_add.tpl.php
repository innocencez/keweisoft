...
<div id="div_setting_1" class="contentList pad-10">
	<table width="100%" class="table_form ">
		...
		<tr>
			...
			<td><?php echo form::select_linkage(3386, 0,'special[typeid]')?></td>
		</tr>
		<tr>
			<th><?php echo '所属行业'?>：</th>
			<td><input name="special[indus]" id="indus" class="input-text" type="text" size="40"><span style="color:red;">请输入所属行业，用“,”分割</span></td>
		</tr>
		<tr>
			<th><?php echo '机构规模'?>：</th>
			<td><?php echo form::select_linkage(3370, 0,'special[scale]')?></td>
		</tr>	
		<tr>
			<th><?php echo '应用模块'?>：</th>
			<td><input name="special[func_tags]" id="func_tags" class="input-text" type="text" size="40"><span style="color:red;">请输入应用模块，用“,”分割</span></td>
		</tr>
		<tr>
			<th><?php echo '系统价值'?>：</th>
			<td><input name="special[values]" id="values" class="input-text" type="text" size="40"><span style="color:red;">请输入系统价值，用“,”分割</span></td>
		</tr>	
		<tr>
